import brainImg from "@assets/Screenshot_20260625-164437_1782391179426.png";

interface Props {
  onNext: () => void;
}

export default function FocusDropsScreen({ onNext }: Props) {
  return (
    <div className="flex flex-col min-h-svh px-6 pt-20" style={{ background: "#000" }}>
      ...
      <div className="flex justify-center mb-8">
        ...
        >
          <span className="font-semibold text-base" style={{ color: "#E05252" }}>500+ reels</span>
        </div>
      </div>

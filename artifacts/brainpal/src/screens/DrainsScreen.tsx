import brainImg from "@assets/Screenshot_20260625-164425_1782391179372.png";

interface Props {
  onNext: () => void;
}

export default function DrainsScreen({ onNext }: Props) {
  return (
    <div className="flex flex-col min-h-svh px-6 pt-20" style={{ background: "#000" }}>
      ...
      <div className="flex justify-center mb-8">
        ...
        >
          <span className="text-white font-semibold text-base">100 reels</span>
        </div>
      </div>
